 ...
 */
  ...
  *          'type' => 'retriever server type (currently supported are IMAP and POP3)',
  *        'server' => 'retriever server hostname',
  *     'mailboxes' => 'Coma separated list of mailbox paths to retrieve mail from. Only in use for IMAP retriever. Default: INBOX.',
